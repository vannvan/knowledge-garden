...
```
### fast-png
[https://github.com/image-js/fast-png](https://github.com/image-js/fast-png)<br />纯JS PNG图像解码器和编码器-通过TypedArray或Buffer传递PNG进行解码，或者传递Canvas ImageData（或兼容对象）以编码为PNG。
## 技术新视界
### Chrome 新特性：文档画中画
